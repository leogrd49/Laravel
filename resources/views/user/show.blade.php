...
<body class="bg-red-100 min-h-screen p-10">
    <div class="max-w-3xl mx-auto bg-white p-6 rounded-lg shadow-lg">
        ...
        <div class="mb-3">
            <a class="bg-red-300 w-min rounded-lg border border-red-800 p-2 font-bold text-center text-red-800 hover:bg-red-400" href="{{ url('/user')}}">Back</a>
        </div>
        <ul class="space-y-4">
